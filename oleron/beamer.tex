...
\hfuzz=100pt % Ignores horizontal overfull warnings under 100pt
\vfuzz=100pt % Ignores vertical overfull warnings under 100pt
...
\usepackage{animate}
\providecommand{\buildmode}{slides}
...
\begin{frame}
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{../shared_assets/octopus.png}
  \end{figure}
\end{frame}

\input|"../.venv/bin/python -u scripts/mab_problem.py --mode \buildmode"
...
\begin{figure}
    ...
    \resizebox{0.8\textwidth}{!}{
        \input{slides/graphics_explained.tex}
    }
\end{figure}
\end{frame}

\input|"../.venv/bin/python -u scripts/eac_beamer.py --mode \buildmode"

\input|"../.venv/bin/python -u scripts/ae_beamer.py --mode \buildmode"

\input|"../.venv/bin/python -u scripts/ucb_beamer.py --mode \buildmode"
...
\begin{figure}
    \centering
    \input{slides/regret_comparison.tex}
\end{figure}
\end{frame}
...
\input|"../.venv/bin/python -u scripts/offline_rl_beamer.py --mode \buildmode"
...
\begin{tikzpicture}[scale=1.2, every node/.style={font=\small}]
    ...
    \node[below left, align=center] at (0.6,0.6) {$C^* = 1$ \\ (expert data)};
...
\vspace{1em}
\pause
\textcolor{gray!70}{Smaller $C^*$ means better overlap between $\beta(a)$ and the optimal arm —} \\
\textcolor{gray!70}{leading to faster convergence and lower offline regret.}
\end{frame}

\begin{frame}
  \begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{../shared_assets/mabs.png}
  \end{figure}
\end{frame}

\input{animations/rl_as_stacked_mab.tex}

\begin{frame}
  \begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{../shared_assets/bridging.png}
  \end{figure}
\end{frame}

\input|"../.venv/bin/python -u scripts/maze_solver_beamer.py --mode \buildmode"
